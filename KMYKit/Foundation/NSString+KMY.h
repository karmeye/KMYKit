...
FOUNDATION_EXPORT   NSString    * _Nullable KMYStringTrimNonVisibleCharacters(NSString * _Nullable stringToTrim) NS_SWIFT_NAME(_kmyStringTrimNonVisibleCharacters(_:));
...
FOUNDATION_EXPORT   BOOL        KMYStringContainsVisibleCharacters(NSString * _Nullable string) NS_SWIFT_NAME(_kmyStringContainsVisibleCharacters(_:));
